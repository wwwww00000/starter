...
return {
  -- change some telescope options and a keymap to browse plugin files
  {
    ...
    keys = {
      ...
      --   "<leader>ff",
      --   function()
      --     require("telescope.builtin").find_files({ cwd = false, no_ignore = true })
      --   end,
      ...
      { "<leader>sB", Util.pick("live_grep", { grep_open_files = true }), desc = "Open Buffers" },
      ...
      { "<leader>sw", Util.pick("grep_string"), mode = "x", desc = "Selection (root dir)" },
      { "<leader>sW", Util.pick("grep_string", { root = false }), mode = "x", desc = "Selection (cwd)" },
